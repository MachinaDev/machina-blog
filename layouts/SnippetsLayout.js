    ...
    <>
      <div className="mx-auto max-w-6xl divide-y divide-gray-400">
        <div className="space-y-2 pb-8 pt-6 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            <input
              ...
              placeholder="Chercher un snippet"
        ...
        <div className="grid grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
          {!filteredBlogPosts.length && 'Aucun snippet trouvé.'}
                ...
                <div className="bg-day dark:bg-night relative space-y-2 rounded-2xl p-4">
                  <article>
                    <div>
                      ...
                      <div className="prose max-w-none text-gray-500 sm:prose-lg dark:text-gray-400">
                        {summary}
                      </div>
